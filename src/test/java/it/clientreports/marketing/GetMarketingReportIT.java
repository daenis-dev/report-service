package it.clientreports.marketing;
...
@SpringBootTest
public class GetMarketingReportIT {

    @Autowired
    private ReportController reportController;

    @Test
    void getTheMarketingReport() {
        ResponseEntity<ReportDetails> theResponse = reportController.findReportForClient("marketing");
